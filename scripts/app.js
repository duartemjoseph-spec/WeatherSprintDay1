const fetchWeatherData = async () => {
    const response = await fetch('https://api.openweathermap.org/data/2.5/weather?lat=37.9575&lon=121.2925&units=imperial&appid=cf7f1c8560a924e6048763d33c150642')
...
const fetchWeeklyData = async () => {
    ...
    const response = await fetch('https://api.openweathermap.org/data/2.5/forecast?lat=37.9575&lon=121.2925&units=imperial&appid=cf7f1c8560a924e6048763d33c150642');
    const data = await response.json();
